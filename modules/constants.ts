...
export const CALLOUT_REGEX = /^>\s*\[!([^\]]+)\]\s*(.*?)$/;
export const BLOCK_ID_REGEX = /\^([\w-]+)\s*$/;
export const CONTENT_EXTRACT_REGEX = /^>\s?/;

// Cache constants
export const CACHE_VERSION = "1.4";
export const PLUGIN_FOLDER = "callout-organizer";
export const CACHE_FILENAME = "callouts.json";
// Lucide icon classifications data
export const LUCIDE_ICON_CLASSIFICATIONS: Record<string, string[]> = 
{
    "a-arrow-down": [
        "text",
        "design"
